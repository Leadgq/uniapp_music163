...
(() => {
  ...
  // C:/Users/Admin/Documents/HBuilderProjects/测试/unpackage/dist/dev/.nvue/pages/mv/mv.js
      ...
      return function(modules) {
        ...
        function(module2, exports2, __webpack_require__) {
          ...
          var Player2 = function(_Proxy) {
            _inherits(Player3, _Proxy);
            function Player3(options) {
              _classCallCheck(this, Player3);
              var _this = _possibleConstructorReturn(this, (Player3.__proto__ || Object.getPrototypeOf(Player3)).call(this, options));
            ...
            _createClass(Player3, [{
              ...
              value: function destroy() {
                ...
                _get(Player3.prototype.__proto__ || Object.getPrototypeOf(Player3.prototype), "destroy", this).call(this);
              }
            }, {
              key: "replay",
        ...
        function(module2, exports2, __webpack_require__) {
          ...
          var Proxy2 = function() {
            function Proxy22(options) {
              var _this = this;
              _classCallCheck(this, Proxy22);
          ...
          var Keyboard = function() {
            ...
            _createClass(Keyboard2, [{
              ...
              value: function initEvents() {
                var _this = this;
                var _player = this.player, root = _player.root, config2 = _player.config;
                ...
                if (!config2.keyShortcut || config2.keyShortcut === "on") {
            ...
            _createClass(XgSubtitles2, [{
              ...
              value: function create(textTrack2) {
                ...
                Object.keys(style).map(function(key) {
                  config2[key] = style[key];
                });
                return new _xgplayerSubtitles2.default(config2);
              }
            }, {
              key: "switch",
        ...
        function(module2, exports2, __webpack_require__) {
          !function(t, e) {
            ...
            function r(t2) {
              var e2 = t2.length;
              return 3 === e2 ? (60 * (60 * Number(t2[0]) + Number(t2[1])) * 1e3 + 1e3 * Number(t2[2])) / 1e3 : 2 === e2 ? (60 * Number(t2[0]) * 1e3 + 1e3 * Number(t2[1])) / 1e3 : Number(t2[0]);
            }
            function i(t2) {
              return /^(\-|\+)?\d+(\.\d+)?$/.test(t2);
            }
            ...
            function a(t2, e2) {
              ...
              var n2 = t2.className && "object" === Je(t2.className) ? t2.getAttribute("class") : t2.className;
              return n2 && !!n2.match(new RegExp("(\\s|^)" + e2 + "(\\s|$)"));
            }
            function u(t2, e2) {
              t2 && (t2.classList ? e2.replace(/(^\s+|\s+$)/g, "").split(/\s+/g).forEach(function(e3) {
                e3 && t2.classList.add(e3);
              }) : a(t2, e2) || (t2.className && "object" === Je(t2.className) ? t2.setAttribute("class", t2.getAttribute("class") + " " + e2) : t2.className += " " + e2));
            }
            function c(t2, e2) {
              t2 && (t2.classList ? e2.split(/\s+/g).forEach(function(e3) {
                ...
                t2.className && "object" === Je(t2.className) ? t2.setAttribute("class", t2.getAttribute("class").replace(n2, " ")) : t2.className = t2.className.replace(n2, " ");
              }));
            }
            function l(t2, e2, n2) {
              var r2 = e2.length;
            ...
            function d() {
              var t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "div", e2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "", n2 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, r2 = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "", i2 = document.createElement(t2);
              return i2.className = r2, i2.innerHTML = e2, kr(n2).forEach(function(e3) {
                var r3 = e3, o2 = n2[e3];
                "video" === t2 || "audio" === t2 || "live-video" === t2 ? o2 && i2.setAttribute(r3, o2) : i2.setAttribute(r3, o2);
              }), i2;
            }
            function p() {
            ...
            function v(t2) {
              var e2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "", n2 = "";
              t2.map(function(t3) {
            ...
            function m(t2) {
              var e2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n2 = { code: Fr[t2].code, msg: Fr[t2].msg };
            ...
            var k = function(t2) {
              ...
              if (!B(t2))
                return t2;
              var n2, r2;
              if (e2 && "function" == typeof (n2 = t2.toString) && !B(r2 = n2.call(t2)))
                return r2;
              if ("function" == typeof (n2 = t2.valueOf) && !B(r2 = n2.call(t2)))
                return r2;
              if (!e2 && "function" == typeof (n2 = t2.toString) && !B(r2 = n2.call(t2)))
                return r2;
              ...
              a2 && (n2 = e2);
              for (r2 in n2)
                (i2 = !s2 && p2 && void 0 !== p2[r2]) && S(h2, r2) || (o2 = i2 ? p2[r2] : n2[r2], h2[r2] = a2 && "function" != typeof p2[r2] ? n2[r2] : l2 && i2 ? z(o2, E) : f2 && p2[r2] == o2 ? function(t3) {
                ...
                }(o2) : c2 && "function" == typeof o2 ? z(Function.call, o2) : o2, c2 && ((h2.virtual || (h2.virtual = {}))[r2] = o2, t2 & Z.R && d2 && !d2[r2] && q(d2, r2, o2)));
            };
            ...
            var et = O.Object.getPrototypeOf, nt = t(e(function(t2) {
              ...
              return "String" == lt(t2) ? t2.split("") : Object(t2);
            }, ht = function(t2) {
              return ft(k(t2));
              ...
              var n2;
              return null !== t2 ? (Et.prototype = D(t2), n2 = new Et(), Et.prototype = null, n2[Ot] = t2) : n2 = Pt(), void 0 === e2 ? n2 : wt(n2, e2);
            }, Mt = e(function(t2) {
              var e2 = P("wks"), n2 = E.Symbol, r2 = "function" == typeof n2;
            ...
            var Lt = function(t2, e2, n2) {
              ...
              }, f2 = e2 + " Iterator", h2 = "values" == i2, d2 = false, p2 = t2.prototype, v2 = p2[It] || p2["@@iterator"] || i2 && p2[i2], y2 = v2 || l2(i2), g2 = i2 ? h2 ? l2("entries") : y2 : void 0, m2 = "Array" == e2 ? p2.entries || v2 : v2;
              if (m2 && (c2 = I(m2.call(new t2()))) !== Object.prototype && c2.next && Rt(c2, f2, true), h2 && v2 && "values" !== v2.name && (d2 = true, y2 = function() {
                return v2.call(this);
            ...
            Bt(Array, "Array", function(t2, e2) {
              ...
              return !t2 || n2 >= t2.length ? (this._t = void 0, Ht(1)) : "keys" == e2 ? Ht(0, n2) : "values" == e2 ? Ht(0, t2[n2]) : Ht(0, [n2, t2[n2]]);
            }, "values");
            ...
            var qt = e(function(t2) {
              ...
              "_" == t2.charAt(0) || t2 in e2 || Zt(e2, t2, { value: Jt.f(t2) });
              ...
              return xt(t2, ie);
            } }, se = oe.f, ae = {}.toString, ue = "object" == typeof window && window && Object.getOwnPropertyNames ? Object.getOwnPropertyNames(window) : [], ce = function(t2) {
              try {
                return se(t2);
              } catch (t3) {
                return ue.slice();
              ...
              return ue && "[object Window]" == ae.call(t2) ? ce(t2) : se(ht(t2));
            ...
            } }, de = qt.KEY, pe = he.f, ve = Y.f, ye = le.f, ge = E.Symbol, me = E.JSON, _e = me && me.stringify, xe = Mt("_hidden"), be = Mt("toPrimitive"), ke = {}.propertyIsEnumerable, we = P("symbol-registry"), Te = P("symbols"), Se = P("op-symbols"), Oe = Object.prototype, Ee = "function" == typeof ge && !!te.f, Pe = E.QObject, je = !Pe || !Pe.prototype || !Pe.prototype.findChild, Me = V && H(function() {
              ...
              return e2._k = t2, e2;
            }, Ce = Ee && "symbol" == typeof ge.iterator ? function(t2) {
              ...
              return void 0 === e2 ? jt(t2) : Ne(jt(t2), e2);
            }, Ie = function(t2) {
            ...
            Q(Q.S + Q.F * Ge, "Object", { getOwnPropertySymbols: function(t2) {
              ...
              var t2 = ge();
              return "[null]" != _e([t2]) || "{}" != _e({ a: t2 }) || "{}" != _e(Object(t2));
            })), "JSON", { stringify: function(t2) {
              for (var e2, n2, r2 = [t2], i2 = 1; arguments.length > i2; )
                r2.push(arguments[i2++]);
              if (n2 = e2 = r2[1], (B(e2) || void 0 !== t2) && !Ce(t2))
                return re(e2) || (e2 = function(t3, e3) {
                  if ("function" == typeof n2 && (e3 = n2.call(this, t3, e3)), !Ce(e3))
                    return e3;
            ...
            var Ke = e(function(t2, e2) {
              ...
              e2.__esModule = true;
              var r2 = n2(Xt), i2 = n2($e), o2 = "function" == typeof i2.default && "symbol" == typeof r2.default ? function(t3) {
                return typeof t3;
              } : function(t3) {
                return t3 && "function" == typeof i2.default && t3.constructor === i2.default && t3 !== i2.default.prototype ? "symbol" : typeof t3;
              };
              e2.default = "function" == typeof i2.default && "symbol" === o2(r2.default) ? function(t3) {
                return void 0 === t3 ? "undefined" : o2(t3);
              } : function(t3) {
                return t3 && "function" == typeof i2.default && t3.constructor === i2.default && t3 !== i2.default.prototype ? "symbol" : void 0 === t3 ? "undefined" : o2(t3);
              };
              ...
              e2.default = function(t3, e3) {
                if (!t3)
                  throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                return !e3 || "object" !== (void 0 === e3 ? "undefined" : (0, n2.default)(e3)) && "function" != typeof e3 ? t3 : e3;
              };
            }));
            ...
            var un, cn, ln, fn = t(e(function(t2, e2) {
              ...
              e2.default = function(t3, e3) {
                if ("function" != typeof e3 && null !== e3)
                  throw new TypeError("Super expression must either be null or a function, not " + (void 0 === e3 ? "undefined" : (0, o2.default)(e3)));
            ...
            })), hn = Mt("toStringTag"), dn = "Arguments" == lt(function() {
              return arguments;
            }()), pn = function(t2, e2) {
              try {
                return t2[e2];
              ...
              var e2, n2, r2;
              return void 0 === t2 ? "Undefined" : null === t2 ? "Null" : "string" == typeof (n2 = pn(e2 = Object(t2), hn)) ? n2 : dn ? lt(e2) : "Object" == (r2 = lt(e2)) && "function" == typeof e2.callee ? "Arguments" : r2;
              ...
              try {
                ...
                var i2 = t2.return;
                throw void 0 !== i2 && D(i2.call(t2)), e3;
              }
            }, mn = Mt("iterator"), _n = Array.prototype, xn = function(t2) {
              return void 0 !== t2 && (ut.Array === t2 || _n[mn] === t2);
              ...
              return void 0 === r2 || void 0 == (n2 = D(r2)[Tn]) ? e2 : F(n2);
            ...
            Pn && jn || (Pn = function(t2) {
              ...
              return Rn[++Cn] = function() {
                On("function" == typeof t2 ? t2 : Function(t2), e2);
              }, un(Cn), Cn;
            }, jn = function(t2) {
              delete Rn[t2];
            }, "process" == lt(En) ? un = function(t2) {
              En.nextTick(z(Nn, t2, 1));
            } : An && An.now ? un = function(t2) {
              An.now(z(Nn, t2, 1));
            } : Mn ? (ln = (cn = new Mn()).port2, cn.port1.onmessage = Ln, un = z(ln.postMessage, ln, 1)) : E.addEventListener && "function" == typeof postMessage && !E.importScripts ? (un = function(t2) {
              E.postMessage(t2 + "", "*");
            ...
            var In = { set: Pn, clear: jn }, Fn = In.set, zn = E.MutationObserver || E.WebKitMutationObserver, Bn = E.process, Dn = E.Promise, Hn = "process" == lt(Bn), Vn = { f: function(t2) {
              return new n(t2);
            } }, Wn = function(t2) {
              try {
                return { e: false, v: t2() };
            ...
            }(), rr = E.TypeError, ir = E.process, or = ir && ir.versions, sr = or && or.v8 || "", ar = E.Promise, ur = "process" == vn(ir), cr = function() {
            }, lr = Zn = Vn.f, fr = !!function() {
              try {
                var t2 = ar.resolve(1), e2 = (t2.constructor = {})[Mt("species")] = function(t3) {
                  t3(cr, cr);
                };
                return (ur || "function" == typeof PromiseRejectionEvent) && t2.then(cr) instanceof e2 && 0 !== sr.indexOf("6.6") && -1 === Un.indexOf("Chrome/66");
              } catch (t3) {
              }
            }(), hr = function(t2) {
              var e2;
              return !(!B(t2) || "function" != typeof (e2 = t2.then)) && e2;
            }, dr = function(t2, e2) {
              if (!t2._n) {
                t2._n = true;
                var n2 = t2._c;
                nr(function() {
                  for (var r2 = t2._v, i2 = 1 == t2._s, o2 = 0; n2.length > o2; )
                    !function(e3) {
                      var n3, o3, s2, a2 = i2 ? e3.ok : e3.fail, u2 = e3.resolve, c2 = e3.reject, l2 = e3.domain;
                      try {
                        a2 ? (i2 || (2 == t2._h && yr(t2), t2._h = 1), true === a2 ? n3 = r2 : (l2 && l2.enter(), n3 = a2(r2), l2 && (l2.exit(), s2 = true)), n3 === e3.promise ? c2(rr("Promise-chain cycle")) : (o3 = hr(n3)) ? o3.call(n3, u2, c2) : u2(n3)) : c2(r2);
                      } catch (t3) {
                        l2 && !s2 && l2.exit(), c2(t3);
                      }
                    }(n2[o2++]);
            ...
            fr || (ar = function(t2) {
              ...
              return n2.ok = "function" != typeof t2 || t2, n2.fail = "function" == typeof e2 && e2, n2.domain = ur ? ir.domain : void 0, this._c.push(n2), this._a && this._a.push(n2), this._s && dr(this, false), n2.promise;
            }, catch: function(t2) {
              ...
              var e2 = "function" == typeof O[t2] ? O[t2] : E[t2];
              ...
              var e2 = Sn(this, O.Promise || E.Promise), n2 = "function" == typeof t2;
            ...
            var br = O.Object.keys, kr = t(e(function(t2) {
              ...
              function i2(t3, n3) {
                0 == --t3._eventsCount ? t3._events = new e2() : delete t3._events[n3];
              }
              function o2() {
              ...
              var e2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n2 = e2.url, r2 = e2.method, i2 = void 0 === r2 ? "GET" : r2, o2 = e2.type, s2 = void 0 === o2 ? "arraybuffer" : o2, a2 = e2.timeout, u2 = void 0 === a2 ? 1e4 : a2, c2 = e2.data, l2 = void 0 === c2 ? {} : c2, f2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
              return rt(this, t2), new xr(function(t3, e3) {
                ...
                if (r3.onload = function() {
                  200 === r3.status || 206 === r3.status ? t3({ context: f2, res: r3 }) : e3(new Error({ context: f2, res: r3, type: "error" }));
              ...
              return Qe(t2, null, [{ key: "parseJson", value: function(t3) {
                ...
                try {
                  var i2 = [];
                  "ass" === r2 ? i2 = t2.parseASS(e2) : "vtt" === r2 && (i2 = t2.parseVTT(e2)), n2({ format: r2, list: i2.list, styles: i2.styles });
                } catch (t3) {
                  console.error(t3), n2({ format: r2 }, t3);
                }
              } }, { key: "parseASSItem", value: function() {
                var t3 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", e2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], n2 = t3.split(","), i2 = {}, s2 = "";
                try {
                  ...
                  return s2 = a2 > 0 ? n2.splice(e2.length - 1, a2 + 1).join(",") + "" : n2[n2.length - 1] + "", s2 = s2.replace(/\\n+/g, ""), s2 = o(s2), n2[e2.length - 1] = s2, e2.map(function(t4, e3) {
                    "end" === t4 || "start" === t4 ? i2[t4] = r(n2[e3].split(":")) : "text" === t4 ? i2[t4] = [n2[e3]] : "layer" === t4 ? (i2[t4] = [n2[e3]], i2.textTag = [n2[e3]]) : i2[t4] = "style" === t4 ? [n2[e3]] : Number(n2[e3]) ? Number(n2[e3]) : n2[e3];
                  }), i2;
                } catch (t4) {
                ...
                if (n2.length > 1) {
                  ...
                  r2.length > 1 ? r2.map(function(t4, e3) {
                    i2 += 0 === e3 ? t4 : t4.charAt(0).toUpperCase() + t4.slice(1);
            ...
            !function(t2, e2) {
              ...
              if (t2 && "undefined" != typeof document) {
                ...
                i2.type = "text/css", "top" === n2 && r2.firstChild ? r2.insertBefore(i2, r2.firstChild) : r2.appendChild(i2), i2.styleSheet ? i2.styleSheet.cssText = t2 : i2.appendChild(document.createTextNode(t2));
              }
            ...
            return function(t2) {
              function e2(t3) {
                ...
                return Br = p(), n2.currentText = null, n2.textTrack = [], n2._cid = -1, n2._gid = -1, n2._cids = [], n2._iId = null, n2._iC = 0, n2.player = null, n2.root = null, n2.config = { line: "double", bottom: 0, mode: "stroke", defaultOpen: false, baseSizeX: 49, baseSizeY: 28, minSize: 16, minMobileSize: 13, fitVideo: true, offsetBottom: 2, fontColor: "#fff" }, n2._ctime = 0, n2._loadingTrack = {}, kr(n2.config).map(function(e3) {
                  void 0 !== t3[e3] && null !== t3[e3] && (n2.config[e3] = t3[e3]);
                }), n2._isOpen = false, n2._videoMeta = { scale: 0, videoHeight: 0, videoWidth: 0, lwidth: 0, lheight: 0, vWidth: 0, vHeight: 0, vBottom: 0, vLeft: 0, marginBottom: 0 }, t3.subTitles && "Array" === h(t3.subTitles) ? (t3.player && n2.attachPlayer(t3.player), n2.setSubTitles(t3.subTitles, n2.config.defaultOpen), n2) : Ye(n2);
              }
              return fn(e2, t2), Qe(e2, [{ key: "version", get: function() {
                return "1.0.12";
              } }]), Qe(e2, [{ key: "setSubTitles", value: function() {
                var t3 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], e3 = this, n2 = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], r2 = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2], i2 = this._isOpen || n2;
                ...
                var t3 = this, e3 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : { id: "", language: "" };
        ...
        function(module2, exports2, __webpack_require__) {
          ...
          var s_danmu = function s_danmu2() {
            ...
            player.once("complete", function() {
              var danmujs = new _danmu2.default(config2);
              ...
              return function(e) {
                ...
                return n.m = e, n.c = t, n.d = function(e2, t2, i) {
                  ...
                  if (1 & t2 && (e2 = n(e2)), 8 & t2)
                    return e2;
                  if (4 & t2 && "object" == (typeof e2 === "undefined" ? "undefined" : _typeof(e2)) && e2 && e2.__esModule)
                    return e2;
                ...
                function h(e2, t2) {
                  if (!e2)
                    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                  return !t2 || "object" != (typeof t2 === "undefined" ? "undefined" : _typeof(t2)) && "function" != typeof t2 ? e2 : t2;
                }
                var d = t.DanmuJs = function(e2) {
                  function t2(e3) {
                    ...
                    }), i2.container = a2.container && 1 === a2.container.nodeType ? a2.container : null, !i2.container)
                  ...
                  return function(e3, t3) {
                    ...
                    var t3 = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], n2 = this.config, i2 = this.main, o2 = this.player, r2 = [], a2 = 0;
                    if (this.logger && this.logger.info("updateComments: " + e3.length + ", isClear " + t3), "boolean" == typeof t3 && t3 && (i2.data = []), i2.data = i2.data.concat(e3), i2.sortData(), "number" == typeof n2.maxCommentsLength && i2.data.length > n2.maxCommentsLength) {
                ...
                o = function o2(e2, t2) {
                  ...
                  var n2;
                  return f(t2), v.call(this, "__ee__") ? n2 = this.__ee__ : (n2 = y.value = p(null), g(this, "__ee__", y), y.value = null), n2[e2] ? "object" == _typeof(n2[e2]) ? n2[e2].push(t2) : n2[e2] = [n2[e2], t2] : n2[e2] = t2, this;
                  ...
                  if (!(n2 = this.__ee__)[e2])
                    return this;
                  if ("object" == _typeof(i2 = n2[e2]))
                    for (r3 = 0; o2 = i2[r3]; ++r3) {
                      o2 !== t2 && o2.__eeOnceListener__ !== t2 || (2 === i2.length ? n2[e2] = i2[r3 ? 0 : 1] : i2.splice(r3, 1));
                    }
                  else
                  ...
                  if (v.call(this, "__ee__") && (o2 = this.__ee__[e2]))
                    if ("object" == (typeof o2 === "undefined" ? "undefined" : _typeof(o2))) {
                  ...
                  return null == e2 ? p(u) : m(Object(e2), l);
                }, t.methods = s;
              }, function(e, t, n) {
                ...
                var l = function(e2) {
                  function t2(e3) {
                    ...
                    var n2 = function(e4, t3) {
                      if (!e4)
                        throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                      return !t3 || "object" != (typeof t3 === "undefined" ? "undefined" : _typeof(t3)) && "function" != typeof t3 ? e4 : t3;
                ...
                var u = function(e2) {
                  ...
                  return function(e3, t3) {
                    ...
                    e3.logger && e3.logger.info("init"), e3.retryStatus = "normal", e3.sortData(), function t3() {
                      "closed" !== e3._status || "stop" !== e3.retryStatus ? ("playing" === e3._status && (e3.readData(), e3.dataHandle()), "stop" === e3.retryStatus && "paused" !== e3._status || (e3.handleTimer = setTimeout(function() {
                    ...
                    if (this.danmu.isReady) {
                      ...
                      if (n2) {
                        ...
                        0 === (l2 = e3.data.splice(0, 1)).length && (l2 = e3.playedData.splice(0, 1));
                      if (l2.length > 0) {
                        o2.updatePos();
                        var c = 2;
                        e:
                          for (var f, h = 0; h < l2.length; h++) {
                            if (f = l2[h], e3.forceDuration && e3.forceDuration !== f.duration && (f.duration = e3.forceDuration), (a2 = new r.default(t3, f)) && !a2.bulletCreateFail) {
                              if (a2.attach(), f.attached_ = true, o2.addBullet(a2).result)
                                ...
                                if (a2 = null, f.attached_ = false, f.noDiscard && (f.prior ? e3.data.unshift(f) : e3.data.push(f)), 0 === c)
                                  break e;
                                c--;
                              }
                            } else {
                ...
                var u = t.Bullet = function(e2) {
                  function t2(e3, n2) {
                    ...
                    if (i2.setLogger("bullet"), i2.danmu = e3, i2.options = n2, i2.duration = n2.duration, i2.id = n2.id, i2.container = e3.container, i2.start = n2.start, i2.prior = n2.prior, i2.realTime = n2.realTime, i2.color = n2.color, i2.bookChannelId = n2.bookChannelId, i2.direction = e3.direction, i2.reuseDOM = true, i2.willChanges = [], i2.domObj = e3.domObj, n2.el && 1 === n2.el.nodeType) {
                      if (n2.el.parentNode)
                    ...
                    "top" === n2.mode || "bottom" === n2.mode ? i2.mode = n2.mode : i2.mode = "scroll", i2.el = r2, n2.like && n2.like.el && i2.setLikeDom(n2.like.el, n2.like.style), i2.status = "waiting";
                    var c = void 0;
                  ...
                  return function(e3, t3) {
                    ...
                    this.danmu && this.danmu.mouseControl && this.danmu.config.mouseControlPause || "waiting" === this.status || "end" === this.status || this.danmu && this.danmu.emit("bullet_hover", { bullet: this, event: e3 });
                    ...
                    if ("paused" !== t3.status && ("forcedPause" !== t3.status && (this.status = "paused"), t3._moveV = void 0, this.el))
                      if (this.willChange(), "scroll" === this.mode) {
                        ...
                        if (e3) {
                          ...
                          r2 = t3.moveMoreS - o2 >= 0 ? "b2t" === this.direction ? (t3.moveMoreS - o2) / t3.moveContainerHeight * n2.height : (t3.moveMoreS - o2) / t3.moveContainerWidth * n2.width : t3.moveMoreS - o2, "b2t" === this.direction ? (0, s.styleUtil)(this.el, "transform", "translateX(-" + this.top + "px) translateY(" + r2 + "px) translateZ(0px) rotate(90deg)") : (0, s.styleUtil)(this.el, "left", r2 + "px");
                        } else
                          "b2t" === this.direction ? (0, s.styleUtil)(this.el, "transform", "translateX(-" + this.top + "px) translateY(" + (this.el.getBoundingClientRect().top - n2.top) + "px) translateZ(0px) rotate(90deg)") : (0, s.styleUtil)(this.el, "left", this.el.getBoundingClientRect().left - n2.left + "px");
                        "b2t" === this.direction || (0, s.styleUtil)(this.el, "transform", "translateX(0px) translateY(0px) translateZ(0px)"), (0, s.styleUtil)(this.el, "transition", "transform 0s linear 0s");
                      } else
                    ...
                    if (this.hasMove || (this.danmu.emit("bullet_start", this), this.hasMove = true), ("forcedPause" !== this.status || e3) && this.el && "start" !== this.status)
                      if (this.status = "start", this.willChanges = ["transform", "transition"], this.willChange(), (0, s.styleUtil)(this.el, "backface-visibility", "hidden"), (0, s.styleUtil)(this.el, "perspective", "500em"), "scroll" === this.mode) {
                    ...
                    this.pauseMove(), this.el && this.el.parentNode && (this.willChanges = [], this.willChange(), this.detach(), this.options.el && 1 === this.options.el.nodeType && this.danmu.config.disableCopyDOM && (0, s.styleUtil)(this.options.el, "transform", "none"), this.danmu.emit("bullet_remove", { bullet: this }));
                    ...
                    if (!e3) {
                      if (this.options.moveV)
                        ...
                        var t3 = this.danmu.containerPos;
                        e3 = ("b2t" === this.direction ? t3.height + this.height : t3.width + this.width) / this.duration * 1e3;
                      }
                ...
                var u = function(e2) {
                  ...
                  return function(e3, t3) {
                      ...
                      for (var h = 0, d = i2.length - a2; h <= d; h++) {
                        ...
                        for (var p = h; p < h + a2; p++) {
                          ...
                          if (g) {
                            ...
                            if ("b2t" === t3.direction ? (b = (v = m.bottom - t3.containerTop) / y, w = t3.containerHeight + e3.random - v) : (b = (v = m.right - t3.containerLeft) / y, w = t3.containerWidth + e3.random - v), _ > y) {
                              var O = w / (_ - y);
                    ...
                    if (-1 !== u2) {
                      ...
                      return e3.channel_id = [u2, a2], "b2t" === t3.direction ? (e3.top = u2 * r2, t3.danmu.config.area && t3.danmu.config.area.start && (e3.top += t3.containerWidth * t3.danmu.config.area.start)) : (e3.top = u2 * o2, t3.danmu.config.area && t3.danmu.config.area.start && (e3.top += t3.containerHeight * t3.danmu.config.area.start)), { result: e3, message: "success" };
                    }
                    ...
                    function n2() {
                      ...
                      if (t3.updatePos(), t3._cancelResizeTimer(), o2.main.data && o2.main.data.forEach(function(e5) {
                        ...
                        (0, l.validAreaLineRule)(u2) ? r2 = u2 : c >= 0 && f >= c && ("b2t" === t3.direction ? t3.width = t3.width * (f - c) : t3.height = t3.height * (f - c));
                      }
                      t3.container = n3;
                      var h = i2.channelSize || (/mobile/gi.test(navigator.userAgent) ? 10 : 12);
                      (0, s.isNumber)(r2) || (r2 = "b2t" === t3.direction ? Math.floor(t3.width / h) : Math.floor(t3.height / h));
                      ...
                      if (t3.channels && t3.channels.length <= d.length) {
                        ...
                        t3.channels = d, "b2t" === t3.direction ? t3.channelWidth = h : t3.channelHeight = h;
                        ...
                        for (var b = function b2(e5) {
                          d[e5] = { id: e5, queue: { scroll: [], top: [], bottom: [] }, operating: { scroll: false, top: false, bottom: false }, bookId: {} }, ["scroll", "top", "bottom"].forEach(function(n4) {
                            if ("top" === n4 && e5 > Math.floor(d.length / 2))
                              ;
                            else if ("bottom" === n4 && e5 <= Math.floor(d.length / 2))
                              ;
                            else {
                              var i3 = "bottom" === n4 ? e5 - d.length + t3.channels.length : e5;
                              t3.channels[i3].queue[n4].forEach(function(o3, r3) {
                                if (o3.el && (d[e5].queue[n4].push(o3), "bottom" === n4 && o3.channel_id[0] + o3.channel_id[1] - 1 === i3)) {
                    ...
                    function a2() {
                      ...
                      if (t3.width = n3.width, t3.height = n3.height, t3.resetId && (cancelAnimationFrame(t3.resetId), t3.resetId = null), r2.area) {
                        ...
                        (0, l.validAreaLineRule)(a3) ? e4 = a3 : u2 >= 0 && c >= u2 && ("b2t" === t3.direction ? t3.width = t3.width * (c - u2) : t3.height = t3.height * (c - u2));
                      }
                      var f = r2.channelSize || (/mobile/gi.test(navigator.userAgent) ? 10 : 12);
                      (0, s.isNumber)(e4) || (e4 = "b2t" === t3.direction ? Math.floor(t3.width / f) : Math.floor(t3.height / f));
                      for (var h = [], d = 0; d < e4; d++) {
                        h[d] = { id: d, queue: { scroll: [], top: [], bottom: [] }, operating: { scroll: false, top: false, bottom: false }, bookId: {} };
                      }
                      t3.channels = h, "b2t" === t3.direction ? t3.channelWidth = f : t3.channelHeight = f;
                    }
                ...
                function g(e2, t2) {
                  ...
                  if ("top" === e2.insertAt)
                    ...
                    if ("object" != _typeof(e2.insertAt) || !e2.insertAt.before)
                      throw new Error("[Style Loader]\n\n Invalid value for parameter 'insertAt' ('options.insertAt') found.\n Must be 'top', 'bottom', or Object.\n (https://github.com/webpack-contrib/style-loader#insertat)\n");
                ...
                e.exports = function(e2, t2) {
                  if ("undefined" != typeof DEBUG && DEBUG && "object" != (typeof document === "undefined" ? "undefined" : _typeof(document)))
                    throw new Error("The style-loader cannot be used in a non-browser environment");
                  (t2 = t2 || {}).attrs = "object" == _typeof(t2.attrs) ? t2.attrs : {}, t2.singleton || "boolean" == typeof t2.singleton || (t2.singleton = a()), t2.insertInto || (t2.insertInto = "head"), t2.insertAt || (t2.insertAt = "bottom");
                  var n2 = p(e2, t2);
  ...
  var Player = /* @__PURE__ */ getDefaultExportFromCjs(dist.exports);
  var config = {
  ...
  var getMvUrl = (id) => http.get(`${config.devPort}/mv/url?id=${id}`);
  var _style_0 = { "mv-container": { "": { "width": 100, "height": 100, "display": "flex", "flexDirection": "column" } } };
  ...
  var _sfc_main = {
    ...
    setup(__props) {
      ...
      const getUrl = () => __async(this, null, function* () {
        var _a;
        let result = yield getMvUrl(props.id);
        url.value = (_a = result.data.url) != null ? _a : "";
      });
      ...
      return (_ctx, _cache) => {
        return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("scroll-view", {
          ...
          (0, import_vue.createElementVNode)("div", { class: "mv-container" }, [
            (0, import_vue.createElementVNode)("div", { id: "mv" })
          ])
        ]);
      };
    }
  };
  var mv = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]], ["__file", "C:/Users/Admin/Documents/HBuilderProjects/\u6D4B\u8BD5/pages/mv/mv.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/mv/mv";
    let __pageQuery = {};
    try {
    ...
    mv.mpType = "page";
    const app = Vue.createPageApp(mv, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...mv.styles || []]));
    app.mount("#root");
  }
})();
/*!
